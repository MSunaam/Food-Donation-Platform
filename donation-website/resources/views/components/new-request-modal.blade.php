            ...
            <div class="modal-body">
                ...
                <form action="{{ route('addRequest') }}" method="post" id="newRequestForm" autocomplete="on" class="needs-validation" novalidate>
                    ...
                    <div>
                        ...
                        <div class="row justify-content-center">
                            <label for="note" class="col-md-3 col-form-label mt-3">Note</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control mt-3" id="note" name="note" placeholder="Note" required>
                                <label for="note" class="error fail-alert"></label>
                            </div>
                        </div>
